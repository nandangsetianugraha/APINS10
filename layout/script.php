		...
		<script src="<?=base_url();?>vendor/bootstrapv5-multiselect/js/bootstrap-multiselect.js"></script>
		...
		<script src="<?=base_url();?>vendor/bootstrapv5-colorpicker/js/bootstrap-colorpicker.js"></script>
		<script src="<?=base_url();?>vendor/bootstrap-timepicker/js/bootstrap-timepicker.js"></script>
		...
		<script src="<?=base_url();?>js/jquery.imgareaselect.js"></script>
